...
import { Plus, Search, Building2, ShieldCheck, MoreHorizontal } from "lucide-react";
...
export default function AgenciesPage() {
  ...
  const getPlanBadge = (plan: SubscriptionPlan) => {
    switch (plan) {
      ...
      case "Standard": return <Badge className="bg-blue-500 text-white border-none">Standard</Badge>;
      case "Premium": return <Badge className="bg-primary text-white font-bold border-none">Premium</Badge>;
    }
  };
  ...
  const getStatusBadge = (status: SubscriptionStatus) => {
    switch (status) {
      ...
      case "Essai": return <Badge className="bg-amber-500 text-white border-none">Essai</Badge>;
